...
function placeXOrO(squareNumber) {
    if (!selectedSquares.some(element => element.includes(squareNumber))) {
        ...
        if (activePlayer === 'X') { //Checks which player is active, if the active player is X it is set to O, and vice versa.
            activePlayer = 'O';
        }
        else {
            activePlayer = 'X';
        ...
        if (activePlayer === 'O') { //Prevents you from clicking during the computer's turn.
            disableClick();
